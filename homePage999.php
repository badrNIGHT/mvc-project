...
$stmt = $conn->prepare("SELECT rôle FROM utilisateurs WHERE id = ?");
$stmt->bind_param("i", $user_id);
$stmt->execute();
$result = $stmt->get_result();
$user_role = $result->fetch_assoc()['rôle'];
//jjjjj
...
<body>
    ...
    <?php if (isset($_SESSION['user_id'])): ?>
        <div class="add-phone-wrapper">
            <a href="<?php echo ($user_role === 'vendeur') ? 'add_product.php' : 'become_seller.php'; ?>" class="add-button">+</a>
