...
<head>
    ...
    <title>Nothing Phone - Shuriken Phone Store</title>
...
<body>
    ...
    <div class="top-bar">
        <div class="logo-container">
            <img src="image/WhatsApp Image 2025-05-02 at 3.33.32 PM.jpeg" alt="Logo" class="logo-light">
    ...
    <header class="video-header">
        <video autoplay muted loop>
            <source src="video/Nothing Phone (1) _ Pub _ What You See Is What You Get.mp4" type="video/mp4">
            Votre navigateur ne supporte pas les vidéos.
        </video>
        <div class="overlay"></div>
        <div class="content">
            <h1>Nothing Phone</h1>
            <p>prenez votre Nothing Phone</p>
        </div>
    ...
    <section class="products-section">
        <h2 class="section-title">Nos téléphones Nothing Phone disponibles</h2>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Load Products
            loadNothingPhoneProducts();

            // Check for session messages
            <?php if (isset($_SESSION['message'])): ?>
                showMessage('<?php echo addslashes($_SESSION['message']); ?>', '<?php echo isset($_SESSION['message_type']) ? $_SESSION['message_type'] : 'success'; ?>');
                <?php unset($_SESSION['message'], $_SESSION['message_type']); ?>
            <?php endif; ?>
        });

        // Load Products from Database
        function loadNothingPhoneProducts() {
            ...
            fetch('get_nothingphone_products.php')
                .then(response => {
                    if (!response.ok) {
                ...
                .then(products => {
                    ...
                    if (!products || products.length === 0) {
                        container.innerHTML = '<div class="no-products" style="text-align:center; padding:20px; grid-column:1/-1">Aucun produit disponible pour le moment</div>';
                        return;
                    }
                ...
                .catch(error => {
                    ...
                    container.innerHTML = `
                        <div class="error" style="text-align:center; padding:20px; grid-column:1/-1">
                            ...
                            <button onclick="loadNothingPhoneProducts()" style="margin-top:10px; padding:5px 10px; background:#0066cc; color:white; border:none; border-radius:4px; cursor:pointer">Réessayer</button>
                        </div>
                    `;
                });
        }
