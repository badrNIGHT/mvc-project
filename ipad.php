...
<head>
    ...
    <title>iPad - Shuriken Phone Store</title>
...
<body>
    ...
    <header class="video-header">
        <video autoplay muted loop>
            <source src="video/Introducing the all-new iPad Pro _ Apple.mp4" type="video/mp4">
            Votre navigateur ne supporte pas les vidéos.
        </video>
        <div class="overlay"></div>
        <div class="content">
            <h1>iPad</h1>
            <p>Prenez votre iPad Pro</p>
        </div>
    ...
    <section class="products-section">
        <h2 class="section-title">Nos iPads disponibles</h2>
                ...
                .catch(error => {
                    ...
                    container.innerHTML = `
                        <div class="error" style="text-align:center; padding:20px; grid-column:1/-1">
                            ...
                            <button onclick="loadIPadProducts()" style="margin-top:10px; padding:5px 10px; background:#0066cc; color:white; border:none; border-radius:4px; cursor:pointer">Réessayer</button>
                        </div>
                    `;
                });
        }
