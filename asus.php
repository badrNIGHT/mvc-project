...
<head>
    ...
    <title>Asus - Shuriken Phone Store</title>
...
<body>
    ...
    <header class="video-header">
        <video autoplay muted loop>
            <source src="video/VID_20250503114724.mp4" type="video/mp4">
            Votre navigateur ne supporte pas les vidéos.
        </video>
        <div class="overlay"></div>
        <div class="content">
            <h1>Asus</h1>
            <p>prenez votre ROG Phone</p>
        </div>
    ...
    <section class="products-section">
        <h2 class="section-title">Nos téléphones Asus disponibles</h2>
