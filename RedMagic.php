...
<head>
    ...
    <title>RedMagic - Shuriken Phone Store</title>
...
<body>
    ...
    <header class="video-header">
        <video autoplay muted loop>
            <source src="video/videoplayback (1).mp4" type="video/mp4">
            Votre navigateur ne supporte pas les vidéos.
        </video>
        <div class="overlay"></div>
        <div class="content">
            <h1>REDMAGIC</h1>
            <p>prenez votre REDMAGIC</p>
        </div>
    ...
    <section class="products-section">
        <h2 class="section-title">Nos téléphones RedMagic disponibles</h2>
   ...
   <footer class="footer">
    ...
    <script>
        ...
        function loadProductsFromDatabase() {
            ...
            fetch('get_RedMagic_products.php')
                .then(response => {
                    if (!response.ok) {
