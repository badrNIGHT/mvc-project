...
<head>
    ...
    <title>Xiaomi - Shuriken Phone Store</title>
...
<body>
    ...
    <header class="video-header">
        <video autoplay muted loop>
            <source src="video/Meet Xiaomi 15 Ultra _ Design.mp4" type="video/mp4">
            Votre navigateur ne supporte pas les vidéos.
        </video>
        <div class="overlay"></div>
        <div class="content">
            <h1>Xiaomi</h1>
            <p>Prenez votre Xiaomi</p>
        </div>
    ...
    <section class="products-section">
        <h2 class="section-title">Nos Xiaomi disponibles</h2>
                ...
                .catch(error => {
                    ...
                    container.innerHTML = `
                        <div class="error" style="text-align:center; padding:20px; grid-column:1/-1">
                            ...
                            <button onclick="loadXiaomiProducts()" style="margin-top:10px; padding:5px 10px; background:#0066cc; color:white; border:none; border-radius:4px; cursor:pointer">Réessayer</button>
                        </div>
                    `;
                });
        }
