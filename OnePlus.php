...
<head>
    ...
    <title>OnePlus - Shuriken Phone Store</title>
...
<body>
    ...
    <header class="video-header">
        <video autoplay muted loop>
            <source src="video/OnePlus Open Apex Edition - Redefining Excellence.mp4" type="video/mp4">
            Votre navigateur ne supporte pas les vidéos.
        </video>
        <div class="overlay"></div>
        <div class="content">
            <h1>OnePlus</h1>
            <p>prenez votre OnePlus</p>
        </div>
    ...
    <section class="products-section">
        <h2 class="section-title">Nos téléphones OnePlus disponibles</h2>
    ...
    <script>
        ...
        function loadOnePlusProducts() {
            ...
            fetch('get_oneplus_products.php')
                .then(response => {
                    if (!response.ok) {
                ...
                .catch(error => {
                    ...
                    container.innerHTML = `
                        <div class="error" style="text-align:center; padding:20px; grid-column:1/-1">
                            ...
                            <button onclick="loadOnePlusProducts()" style="margin-top:10px; padding:5px 10px; background:#0066cc; color:white; border:none; border-radius:4px; cursor:pointer">Réessayer</button>
                        </div>
                    `;
                });
        }
