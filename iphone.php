...
<head>
    ...
    <title>iPhone - Shuriken Phone Store</title>
...
<body>
    ...
    <header class="video-header">
        <video autoplay muted loop>
            <source src="video/video d iphone.mp4" type="video/mp4">
            Votre navigateur ne supporte pas les vidéos.
        </video>
        <div class="overlay"></div>
        <div class="content">
            <h1>iPhone</h1>
            <p>prenez votre iPhone</p>
        </div>
    ...
    <section class="products-section">
        <h2 class="section-title">Nos téléphones iPhone disponibles</h2>
                ...
                .catch(error => {
                    ...
                    container.innerHTML = `
                        <div class="error" style="text-align:center; padding:20px; grid-column:1/-1">
                            ...
                            <button onclick="loadIPhoneProducts()" style="margin-top:10px; padding:5px 10px; background:#0066cc; color:white; border:none; border-radius:4px; cursor:pointer">Réessayer</button>
                        </div>
                    `;
                });
        }
