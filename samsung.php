...
<head>
    ...
    <title>Samsung - Shuriken Phone Store</title>
...
<body>
    ...
    <header class="video-header">
        <video autoplay muted loop>
            <source src="video/VID_20250503132431.mp4" type="video/mp4">
            Votre navigateur ne supporte pas les vidéos.
        </video>
        <div class="overlay"></div>
        <div class="content">
            <h1>Samsung</h1>
            <p>Découvrez nos derniers modèles Samsung</p>
        </div>
    ...
    <section class="products-section">
        <h2 class="section-title">Nos téléphones Samsung disponibles</h2>
    ...
    <div id="message" class="<?php echo isset($_SESSION['message']) ? 'show' : ''; ?>">
    ...
    <script>
        ...
        function loadProductsFromDatabase() {
            ...
            fetch('get_samsung_products.php')
                .then(response => {
                    if (!response.ok) {
